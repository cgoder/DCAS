...
#ifndef _SKYWORTH_CA_CD_
#define _SKYWORTH_CA_CD_
...
#define SKYCAS_CDCAS_FILE_SIZE_MAX (64*1024)
...
}SKYCAS_CdcaMessageShowBuyParam_S;

typedef SKYCAS_VOID(*SKYCAS_PostEvent_CB)(SKYCAS_EVENT_S eCAEvent);


class CSkyworth_Cdca : public  skyworth_ca_api
{
public:

/***********************************************************************
函数名:
	static CSkyworth_Cdca* GetCaInstance(SKYCAS_VOID);
功能:
得到类的一个实例。
参数:
[IN]
...
[RET]	
	返回CAS ID
SKYCAS_S16 SKYCAS_GetCASID(SKYCAS_VOID);
************************************************************************/
...
public:	
	SKYCAS_S32 SKYCAS_SetPrivateData(SKYCAS_U8 u8ReqID, const SKYCAS_U8* pU8Match, 
	...
	SKYCAS_VOID CDDATATODATA(SKYCAS_U16 days,SKYCAS_DATETIME_S *pDATATIME);
public:	
	static CSkyworth_Cdca *pSkyworthCAApi;
...
private:
	...
	SKYCAS_U32 m_PriDataTaskId;
 	 SKYCAS_CHAR pCDcaFilePath[SKYCAS_FILE_PATH_LEN_MAX];//[256];
...
private:
	...
	SKYCAS_BOOL IsSame(SKYCAS_U8 index,SKYCAS_U8 reqId,SKYCAS_U16 pid,const SKYCAS_U8 *filterData,
		const SKYCAS_U8 *filterMask,SKYCAS_U8 filterLen);
